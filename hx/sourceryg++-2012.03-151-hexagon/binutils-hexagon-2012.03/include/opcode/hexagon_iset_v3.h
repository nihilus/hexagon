...
HEXAGON_OPCODE ("Rd32 = Ss64"                            , "0110 1110 1-ssssss 00------ ---ddddd"       , 0x8, 0, 0)
...
HEXAGON_OPCODE ("Rd32 = extractu ( Rs32 , Rtt32 )"       , "1100 1001  00-sssss  00-ttttt 00-ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rd32 = getimask ( Rs32 )"               , "0110 0110 000sssss 00------ ---ddddd"       , 0x8, 0, 0|A_SOLO)
...
HEXAGON_OPCODE ("Rd32 = memw_locked ( Rs32 )"            , "1001 001 0 000 sssss 000----- ---ddddd"     , 0x1, 0, 0|A_RESTRICT_SLOT1_EMPTY|A_RESTRICT_AX|A_MEMORY)
...
HEXAGON_OPCODE ("Rd32 = vradduh ( Rss32 , Rtt32 )"       , "111010010--sssss  00-ttttt -01ddddd"        , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rd32 = vrcmpys ( Rss32 , Rtt32 ) :<<1 :rnd :sat :raw :hi" , "111010011-1sssss  00-ttttt 110ddddd"        , 0xc, 0|IMPLICIT_SR_OVF, 0)
HEXAGON_OPCODE ("Rd32 = vrcmpys ( Rss32 , Rtt32 ) :<<1 :rnd :sat :raw :lo" , "111010011-1sssss  00-ttttt 111ddddd"        , 0xc, 0|IMPLICIT_SR_OVF, 0)
...
HEXAGON_OPCODE ("Rdd32 = add ( Rss32 , Rtt32 ) :raw :hi" , "1101 -011  011sssss  00-ttttt 111ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = add ( Rss32 , Rtt32 ) :raw :lo" , "1101 -011  011sssss  00-ttttt 110ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = add ( Rss32 , Rtt32 ) :sat"     , "1101 -011  011sssss  00-ttttt 101ddddd"     , 0xc, 0|IMPLICIT_SR_OVF, 0)
...
HEXAGON_OPCODE ("Rdd32 = decbin ( Rss32 , Rtt32 )"       , "1100 0001  11-sssss  00-ttttt 11-ddddd"     , 0xc, 0|IMPLICIT_P0, 0|A_LATEPRED)
...
HEXAGON_OPCODE ("Rdd32 = extractu ( Rss32 , Rtt32 )"     , "1100 0001  00-sssss  00-ttttt 00-ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = interleave ( Rss32 )"           , "1000 0000  11-sssss  00------ 1 01ddddd"    , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = lfs ( Rss32 , Rtt32 )"          , "1100 0001  10-sssss  00-ttttt 11-ddddd"     , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rdd32 = max ( Rss32 , Rtt32 )"          , "1101 -011  110sssss  00-ttttt 100ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = maxu ( Rss32 , Rtt32 )"         , "1101 -011  110sssss  00-ttttt 101ddddd"     , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rdd32 = min ( Rtt32 , Rss32 )"          , "1101 -011  101sssss  00-ttttt 110ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = minu ( Rtt32 , Rss32 )"         , "1101 -011  101sssss  00-ttttt 111ddddd"     , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rdd32 = shuffeb ( Rss32 , Rtt32 )"      , "1100 0001  00-sssss  00-ttttt 01-ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = shuffeh ( Rss32 , Rtt32 )"      , "1100 0001  00-sssss  00-ttttt 11-ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = shuffob ( Rtt32 , Rss32 )"      , "1100 0001  00-sssss  00-ttttt 10-ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = shuffoh ( Rtt32 , Rss32 )"      , "1100 0001  10-sssss  00-ttttt 00-ddddd"     , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rdd32 = vavguw ( Rss32 , Rtt32 ) :rnd"  , "1101 -011  011sssss  00-ttttt 100ddddd"     , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rdd32 = vrcmpys ( Rss32 , Rtt32 ) :<<1 :sat :raw :hi" , "11101000101sssss  00-ttttt 100ddddd"        , 0xc, 0|IMPLICIT_SR_OVF, 0)
HEXAGON_OPCODE ("Rdd32 = vrcmpys ( Rss32 , Rtt32 ) :<<1 :sat :raw :lo" , "11101000111sssss  00-ttttt 100ddddd"        , 0xc, 0|IMPLICIT_SR_OVF, 0)
...
HEXAGON_OPCODE ("Rdd32 = vtrunewh ( Rss32 , Rtt32 )"     , "1100 0001  10-sssss  00-ttttt 01-ddddd"     , 0xc, 0, 0)
HEXAGON_OPCODE ("Rdd32 = vtrunowh ( Rss32 , Rtt32 )"     , "1100 0001  10-sssss  00-ttttt 10-ddddd"     , 0xc, 0, 0)
...
HEXAGON_OPCODE ("Rxx32 += vrcmpys ( Rss32 , Rtt32 ) :<<1 :sat :raw :hi" , "11101010101sssss  00-ttttt 100xxxxx"        , 0xc, 0|IMPLICIT_SR_OVF, 0)
HEXAGON_OPCODE ("Rxx32 += vrcmpys ( Rss32 , Rtt32 ) :<<1 :sat :raw :lo" , "11101010111sssss  00-ttttt 100xxxxx"        , 0xc, 0|IMPLICIT_SR_OVF, 0)
...
HEXAGON_OPCODE ("Sd64 = Rs32"                            , "0110 0111 00-sssss 00------ --dddddd"       , 0x8, 0, 0|A_RESTRICT_AX|A_RESTRICT_AX_SOMEREGS)
HEXAGON_OPCODE ("allocframe ( #u11:3 )"                  , "1010 000 01 0011101 00000iii iiiiiiii"      , 0x1, 0|IMPLICIT_SP|IMPLICIT_FP, 0|A_STORE|A_MEMORY)
...
HEXAGON_OPCODE ("crswap ( Rx32 , sgp )"                  , "0110 0101 000xxxxx 00------ --------"       , 0x8, 0, 0)
...
HEXAGON_OPCODE ("dcfetch ( Rs32 + #u11:3 )"              , "1001 010 0 000 sssss 000--iii iiiiiiii"     , 0x1, 0, 0|A_MEMORY)
...
HEXAGON_OPCODE ("dczeroa ( Rs32 )"                       , "1010 000 01 10sssss 00------ --------"      , 0x1, 0, 0|A_STORE|A_RESTRICT_SLOT1_EMPTY|A_MEMORY)
...
HEXAGON_OPCODE ("if ! Pu4 .new jump:nt #r15:2"           , "0101 1100  ii1iiiii  00i01-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED |A_CONDITION_DOTNEW)
HEXAGON_OPCODE ("if ! Pu4 .new jump:t #r15:2"            , "0101 1100  ii1iiiii  00i11-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED |A_CONDITION_DOTNEW)
HEXAGON_OPCODE ("if ! Pu4 .new jumpr:nt Rs32"            , "0101 0011  011sssss  00-01-uu  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED |A_CONDITION_DOTNEW)
HEXAGON_OPCODE ("if ! Pu4 .new jumpr:t Rs32"             , "0101 0011  011sssss  00-11-uu  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED |A_CONDITION_DOTNEW)
...
HEXAGON_OPCODE ("if ! Pu4 call #r15:2"                   , "0101 1101  ii1iiiii  00i00-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC|IMPLICIT_LR, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pu4 callr Rs32"                    , "0101 0001  001sssss  00----uu  --------"    , 0x4, 0|IMPLICIT_PC|IMPLICIT_LR, 0|A_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pu4 jump #r15:2"                   , "0101 1100  ii1iiiii  00i00-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_DUALJUMP_1|A_DUALJUMP_2|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pu4 jumpr Rs32"                    , "0101 0011  011sssss  00-00-uu  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH|A_CONDEXEC|A_CONDITION_INVERTED )
...
HEXAGON_OPCODE ("if ! Pv4 memb ( Rs32 + #u6:0 ) = Rt32"  , "0100 0100 000  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pv4 memb ( Rx32 ++ #s4:0 ) = Rt32" , "1010 1 01 1 000  xxxxx  001ttttt  -iiii1vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
...
HEXAGON_OPCODE ("if ! Pv4 memd ( Rs32 + #u6:3 ) = Rtt32" , "0100 0100 110  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pv4 memd ( Rx32 ++ #s4:3 ) = Rtt32" , "1010 1 01 1 110  xxxxx  001ttttt  -iiii1vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
...
HEXAGON_OPCODE ("if ! Pv4 memh ( Rs32 + #u6:1 ) = Rt32.h" , "0100 0100 011  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pv4 memh ( Rs32 + #u6:1 ) = Rt32"  , "0100 0100 010  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pv4 memh ( Rx32 ++ #s4:1 ) = Rt32.h" , "1010 1 01 1 011  xxxxx  001ttttt  -iiii1vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pv4 memh ( Rx32 ++ #s4:1 ) = Rt32" , "1010 1 01 1 010  xxxxx  001ttttt  -iiii1vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
...
HEXAGON_OPCODE ("if ! Pv4 memw ( Rs32 + #u6:2 ) = Rt32"  , "0100 0100 100  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
HEXAGON_OPCODE ("if ! Pv4 memw ( Rx32 ++ #s4:2 ) = Rt32" , "1010 1 01 1 100  xxxxx  001ttttt  -iiii1vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC|A_CONDITION_INVERTED )
...
HEXAGON_OPCODE ("if ( Pu4 ) call #r15:2"                 , "0101 1101  ii0iiiii  00i00-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC|IMPLICIT_LR, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pu4 ) callr Rs32"                  , "0101 0001  000sssss  00----uu  --------"    , 0x4, 0|IMPLICIT_PC|IMPLICIT_LR, 0|A_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pu4 ) jump #r15:2"                 , "0101 1100  ii0iiiii  00i00-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_DUALJUMP_1|A_DUALJUMP_2|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pu4 ) jumpr Rs32"                  , "0101 0011  010sssss  00-00-uu  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH|A_CONDEXEC)
...
HEXAGON_OPCODE ("if ( Pu4 .new ) jump:nt #r15:2"         , "0101 1100  ii0iiiii  00i01-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC|A_CONDITION_DOTNEW)
HEXAGON_OPCODE ("if ( Pu4 .new ) jump:t #r15:2"          , "0101 1100  ii0iiiii  00i11-uu  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC|A_CONDITION_DOTNEW)
HEXAGON_OPCODE ("if ( Pu4 .new ) jumpr:nt Rs32"          , "0101 0011  010sssss  00-01-uu  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH|A_CONDEXEC|A_CONDITION_DOTNEW)
HEXAGON_OPCODE ("if ( Pu4 .new ) jumpr:t Rs32"           , "0101 0011  010sssss  00-11-uu  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH|A_CONDEXEC|A_CONDITION_DOTNEW)
...
HEXAGON_OPCODE ("if ( Pv4 ) memb ( Rs32 + #u6:0 ) = Rt32" , "0100 0000 000  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pv4 ) memb ( Rx32 ++ #s4:0 ) = Rt32" , "1010 1 01 1 000  xxxxx  001ttttt  -iiii0vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
...
HEXAGON_OPCODE ("if ( Pv4 ) memd ( Rs32 + #u6:3 ) = Rtt32" , "0100 0000 110  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pv4 ) memd ( Rx32 ++ #s4:3 ) = Rtt32" , "1010 1 01 1 110  xxxxx  001ttttt  -iiii0vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
...
HEXAGON_OPCODE ("if ( Pv4 ) memh ( Rs32 + #u6:1 ) = Rt32.h" , "0100 0000 011  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pv4 ) memh ( Rs32 + #u6:1 ) = Rt32" , "0100 0000 010  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pv4 ) memh ( Rx32 ++ #s4:1 ) = Rt32.h" , "1010 1 01 1 011  xxxxx  001ttttt  -iiii0vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pv4 ) memh ( Rx32 ++ #s4:1 ) = Rt32" , "1010 1 01 1 010  xxxxx  001ttttt  -iiii0vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
...
HEXAGON_OPCODE ("if ( Pv4 ) memw ( Rs32 + #u6:2 ) = Rt32" , "0100 0000 100  sssss  00ittttt  iiiii-vv"   , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Pv4 ) memw ( Rx32 ++ #s4:2 ) = Rt32" , "1010 1 01 1 100  xxxxx  001ttttt  -iiii0vv" , 0x1, 0, 0|A_STORE|A_MEMORY|A_CONDEXEC)
...
HEXAGON_OPCODE ("if ( Rs32 != #0 ) jump:nt #r13:2"       , "0110 0001  00isssss  00i0iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 != #0 ) jump:t #r13:2"        , "0110 0001  00isssss  00i1iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 <= #0 ) jump:nt #r13:2"       , "0110 0001  11isssss  00i0iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 <= #0 ) jump:t #r13:2"        , "0110 0001  11isssss  00i1iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 == #0 ) jump:nt #r13:2"       , "0110 0001  10isssss  00i0iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 == #0 ) jump:t #r13:2"        , "0110 0001  10isssss  00i1iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 >= #0 ) jump:nt #r13:2"       , "0110 0001  01isssss  00i0iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
HEXAGON_OPCODE ("if ( Rs32 >= #0 ) jump:t #r13:2"        , "0110 0001  01isssss  00i1iiii  iiiiiii-"    , 0x8, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_CONDEXEC)
...
HEXAGON_OPCODE ("jump #r22:2"                            , "0101 100i  iiiiiiii  00iiiiii  iiiiiii-"    , 0xc, 0|IMPLICIT_PC, 0|A_BRANCH|A_PCREL_BRANCH|A_DUALJUMP_2)
HEXAGON_OPCODE ("jumpr Rs32"                             , "0101 0010  100sssss  00------  --------"    , 0x4, 0|IMPLICIT_PC, 0|A_BRANCH)
HEXAGON_OPCODE ("k0lock"                                 , "0110 1100 001----- 00------ 011-----"       , 0x8, 0, 0|A_SOLO)
HEXAGON_OPCODE ("k0unlock"                               , "0110 1100 001----- 00------ 100-----"       , 0x8, 0, 0|A_SOLO)
HEXAGON_OPCODE ("l2cleaninvidx ( Rs32 )"                 , "1010 100 00 11sssss 00------ --------"      , 0x1, 0, 0|A_RESTRICT_SLOT1_EMPTY|A_MEMORY)
HEXAGON_OPCODE ("l2kill"                                 , "1010 100 00 01----- 00------ --------"      , 0x1, 0, 0|A_SOLO)
HEXAGON_OPCODE ("loop0 ( #r7:2 , #U10 )"                 , "0110 1001  000IIIII  00-iiiii  IIIii-II"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF, 0|A_PCREL_BRANCH|A_HWLOOP)
HEXAGON_OPCODE ("loop0 ( #r7:2 , Rs32 )"                 , "0110 0000  000sssss  00-iiiii  ---ii---"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF, 0|A_PCREL_BRANCH|A_HWLOOP)
HEXAGON_OPCODE ("loop1 ( #r7:2 , #U10 )"                 , "0110 1001  001IIIII  00-iiiii  IIIii-II"    , 0x8, 0|IMPLICIT_LC1|IMPLICIT_SA1, 0|A_PCREL_BRANCH|A_HWLOOP)
HEXAGON_OPCODE ("loop1 ( #r7:2 , Rs32 )"                 , "0110 0000  001sssss  00-iiiii  ---ii---"    , 0x8, 0|IMPLICIT_LC1|IMPLICIT_SA1, 0|A_PCREL_BRANCH|A_HWLOOP)
HEXAGON_OPCODE ("memb ( #g16:0 ) = Rt32"                 , "0100 1ii0 000  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memb ( gp + #u16:0 ) = Rt32"            , "0100 1ii0 000  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
...
HEXAGON_OPCODE ("memb ( Rs32 + #s11:0 ) = Rt32"          , "1010 0 ii 1 000  sssss  00ittttt  iiiiiiii" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memb ( Rx32 ++ #s4:0 ) = Rt32"          , "1010 1 01 1 000  xxxxx  000ttttt  0iiii---" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memb ( Rx32 ++ #s4:0 :circ ( Mu2 ) ) = Rt32" , "1010 1 00 1 000  xxxxx  00uttttt  0iiii-0-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memb ( Rx32 ++ Mu2 ) = Rt32"            , "1010 1 10 1 000  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memb ( Rx32 ++ Mu2 :brev ) = Rt32"      , "1010 1 11 1 000  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memb ( Rx32 ++I :circ ( Mu2 ) ) = Rt32" , "1010 1 00 1 000  xxxxx  00uttttt  0-----1-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( #g16:3 ) = Rtt32"                , "0100 1ii0 110  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( gp + #u16:3 ) = Rtt32"           , "0100 1ii0 110  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
...
HEXAGON_OPCODE ("memd ( Rs32 + #s11:3 ) = Rtt32"         , "1010 0 ii 1 110  sssss  00ittttt  iiiiiiii" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( Rx32 ++ #s4:3 ) = Rtt32"         , "1010 1 01 1 110  xxxxx  000ttttt  0iiii---" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( Rx32 ++ #s4:3 :circ ( Mu2 ) ) = Rtt32" , "1010 1 00 1 110  xxxxx  00uttttt  0iiii-0-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( Rx32 ++ Mu2 ) = Rtt32"           , "1010 1 10 1 110  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( Rx32 ++ Mu2 :brev ) = Rtt32"     , "1010 1 11 1 110  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memd ( Rx32 ++I :circ ( Mu2 ) ) = Rtt32" , "1010 1 00 1 110  xxxxx  00uttttt  0-----1-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( #g16:1 ) = Rt32.h"               , "0100 1ii0 011  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( #g16:1 ) = Rt32"                 , "0100 1ii0 010  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( gp + #u16:1 ) = Rt32.h"          , "0100 1ii0 011  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( gp + #u16:1 ) = Rt32"            , "0100 1ii0 010  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
...
HEXAGON_OPCODE ("memh ( Rs32 + #s11:1 ) = Rt32.h"        , "1010 0 ii 1 011  sssss  00ittttt  iiiiiiii" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rs32 + #s11:1 ) = Rt32"          , "1010 0 ii 1 010  sssss  00ittttt  iiiiiiii" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ #s4:1 ) = Rt32.h"        , "1010 1 01 1 011  xxxxx  000ttttt  0iiii---" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ #s4:1 ) = Rt32"          , "1010 1 01 1 010  xxxxx  000ttttt  0iiii---" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ #s4:1 :circ ( Mu2 ) ) = Rt32.h" , "1010 1 00 1 011  xxxxx  00uttttt  0iiii-0-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ #s4:1 :circ ( Mu2 ) ) = Rt32" , "1010 1 00 1 010  xxxxx  00uttttt  0iiii-0-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ Mu2 ) = Rt32.h"          , "1010 1 10 1 011  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ Mu2 ) = Rt32"            , "1010 1 10 1 010  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ Mu2 :brev ) = Rt32.h"    , "1010 1 11 1 011  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++ Mu2 :brev ) = Rt32"      , "1010 1 11 1 010  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++I :circ ( Mu2 ) ) = Rt32.h" , "1010 1 00 1 011  xxxxx  00uttttt  0-----1-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memh ( Rx32 ++I :circ ( Mu2 ) ) = Rt32" , "1010 1 00 1 010  xxxxx  00uttttt  0-----1-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( #g16:2 ) = Rt32"                 , "0100 1ii0 100  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( gp + #u16:2 ) = Rt32"            , "0100 1ii0 100  iiiii  00ittttt  iiiiiiii"   , 0x1, 0, 0|A_STORE|A_MEMORY)
...
HEXAGON_OPCODE ("memw ( Rs32 + #s11:2 ) = Rt32"          , "1010 0 ii 1 100  sssss  00ittttt  iiiiiiii" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( Rx32 ++ #s4:2 ) = Rt32"          , "1010 1 01 1 100  xxxxx  000ttttt  0iiii---" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( Rx32 ++ #s4:2 :circ ( Mu2 ) ) = Rt32" , "1010 1 00 1 100  xxxxx  00uttttt  0iiii-0-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( Rx32 ++ Mu2 ) = Rt32"            , "1010 1 10 1 100  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( Rx32 ++ Mu2 :brev ) = Rt32"      , "1010 1 11 1 100  xxxxx  00uttttt  0-------" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw ( Rx32 ++I :circ ( Mu2 ) ) = Rt32" , "1010 1 00 1 100  xxxxx  00uttttt  0-----1-" , 0x1, 0, 0|A_STORE|A_MEMORY)
HEXAGON_OPCODE ("memw_locked ( Rs32 , Pd4 ) = Rt32"      , "1010 000 01 01sssss 00-ttttt ------dd"      , 0x1, 0, 0|A_STORE|A_RESTRICT_SLOT1_EMPTY|A_RESTRICT_AX|A_LATEPRED|A_MEMORY)
HEXAGON_OPCODE ("nop"                                    , "0111 1111 -------- 00------ --------"       , 0xf, 0, 0|A_NOP)
HEXAGON_OPCODE ("p3 = sp1loop0 ( #r7:2 , #U10 )"         , "0110 1001  101IIIII  00-iiiii  IIIii-II"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF|IMPLICIT_P3, 0|A_PCREL_BRANCH|A_HWLOOP|A_LATEPRED)
HEXAGON_OPCODE ("p3 = sp1loop0 ( #r7:2 , Rs32 )"         , "0110 0000  101sssss  00-iiiii  ---ii---"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF|IMPLICIT_P3, 0|A_PCREL_BRANCH|A_HWLOOP|A_LATEPRED)
HEXAGON_OPCODE ("p3 = sp2loop0 ( #r7:2 , #U10 )"         , "0110 1001  110IIIII  00-iiiii  IIIii-II"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF|IMPLICIT_P3, 0|A_PCREL_BRANCH|A_HWLOOP|A_LATEPRED)
HEXAGON_OPCODE ("p3 = sp2loop0 ( #r7:2 , Rs32 )"         , "0110 0000  110sssss  00-iiiii  ---ii---"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF|IMPLICIT_P3, 0|A_PCREL_BRANCH|A_HWLOOP|A_LATEPRED)
HEXAGON_OPCODE ("p3 = sp3loop0 ( #r7:2 , #U10 )"         , "0110 1001  111IIIII  00-iiiii  IIIii-II"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF|IMPLICIT_P3, 0|A_PCREL_BRANCH|A_HWLOOP|A_LATEPRED)
HEXAGON_OPCODE ("p3 = sp3loop0 ( #r7:2 , Rs32 )"         , "0110 0000  111sssss  00-iiiii  ---ii---"    , 0x8, 0|IMPLICIT_LC0|IMPLICIT_SA0|IMPLICIT_SR_OVF|IMPLICIT_P3, 0|A_PCREL_BRANCH|A_HWLOOP|A_LATEPRED)
HEXAGON_OPCODE ("pause ( #u8 )"                          , "0101 0100  01------  00-iiiii  ---iii--"    , 0x4, 0, 0|A_SOLO)
HEXAGON_OPCODE ("resume ( Rs32 )"                        , "0110 0100 010sssss 00------ 001-----"       , 0x8, 0, 0|A_SOLO)
HEXAGON_OPCODE ("rteunlock"                              , "0101 0111  111-----  0001----  000-----"    , 0x4, 0|IMPLICIT_PC, 0)
HEXAGON_OPCODE ("rte"                                    , "0101 0111  111-----  0000----  000-----"    , 0x4, 0|IMPLICIT_PC, 0)
HEXAGON_OPCODE ("setimask ( Pt4 , Rs32 )"                , "0110 0100 100sssss 00----tt --------"       , 0x8, 0, 0|A_SOLO)
...
HEXAGON_OPCODE ("tlblock"                                , "0110 1100 001----- 00------ 001-----"       , 0x8, 0, 0|A_SOLO)
HEXAGON_OPCODE ("tlbp"                                   , "0110 1100 100----- 00------ --------"       , 0x8, 0, 0|A_RESTRICT_AX)
HEXAGON_OPCODE ("tlbr"                                   , "0110 1100 010----- 00------ --------"       , 0x8, 0, 0|A_RESTRICT_AX)
HEXAGON_OPCODE ("tlbunlock"                              , "0110 1100 001----- 00------ 010-----"       , 0x8, 0, 0|A_SOLO)
HEXAGON_OPCODE ("tlbw"                                   , "0110 1100 000----- 00------ --------"       , 0x8, 0, 0|A_RESTRICT_AX)
HEXAGON_OPCODE ("trap0 ( #u8 )"                          , "0101 0100  00------  00-iiiii  ---iii--"    , 0x4, 0, 0|A_SOLO)
HEXAGON_OPCODE ("trap1 ( #u8 )"                          , "0101 0100  10------  00-iiiii  ---iii--"    , 0x4, 0, 0|A_SOLO)
