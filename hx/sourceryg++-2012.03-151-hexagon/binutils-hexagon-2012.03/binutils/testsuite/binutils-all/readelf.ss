...
# hexagon targets include extra SECTION symbols here for .sdata, .sbss
#...
 +[13]: 00000000 +0 +SECTION +LOCAL +DEFAULT +1 
 +[24]: 00000000 +0 +SECTION +LOCAL +DEFAULT +[34] 
 +[35]: 00000000 +0 +SECTION +LOCAL +DEFAULT +[45] 
 +[46]: 00000000 +0 +NOTYPE +LOCAL +DEFAULT +1 static_text_symbol
...
#...
 ...
 +..: 00000004 +4 +(COMMON|OBJECT) +GLOBAL +DEFAULT +(COM|ANSI_COM|PRC.0x[0-9a-f]+.) common_symbol
